...
<!-- 顾客管理 -->
    ...
    <el-table-column fixed="left" prop="customerId" label="顾客编号"></el-table-column>
    <el-table-column fixed="left" prop="province" label="省份"></el-table-column>
    <el-table-column fixed="left" prop="area" label="地区名"></el-table-column>
    <el-table-column fixed="left" prop="address" label="地址"></el-table-column>
    <el-table-column prop="status" label="状态"></el-table-column>
    <el-table-column width="120" prop="telephone" label="电话号码"></el-table-column>
        ...
        <el-dialog
            ...
            <el-form-item label="省份名">
         <el-input type="province" v-model="form.province"/>
      </el-form-item>
            <el-form-item label="城市名">
              <el-input type="city" v-model="form.city"/>
                </el-form-item>
